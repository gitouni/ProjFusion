...
def options():
    ...
    parser.add_argument("--index",type=int,default=1572)
    ...
    parser.add_argument("--method_dirs",type=str,default=[
        'experiments/calibnet/kitti/results/iterative_1_2025-02-24-20-28-35',
        'experiments/rggnet/kitti/results/iterative_1_2025-02-24-20-36-57',
        'experiments/lccnet/kitti/results/iterative_1_2025-02-24-20-32-40',
        'experiments/lccnet_mr5/kitti/results/mr_5_2025-03-30-15-47-03',
        'experiments/lccraft/kitti/results/iterative_1_2025-02-24-20-41-08',
        'experiments/calib_depth/kitti/results/bc_3_2025-03-25-22-32-58',
        'experiments/pool_3c_t/kitti_bc/results/ppo_10_2025-03-22-11-45-46',
        'experiments/pool_3c_t/kitti/results/ppo_10_2025-04-03-23-21-05'
    ])
