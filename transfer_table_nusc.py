...
parser.add_argument("--method_list",type=str,nargs="+",default=['calibnet','rggnet','lccnet','lccnet_mr5','lccraft','calibdepth','pool_3c_t_bc','pool_3c_t','pool_3c_t_res_bc','pool_3c_t_res','pool_3c_t_bc_gn','pool_3c_t_gn','pool_3c_t_s15'])
parser.add_argument("--name_method_list",type=str,nargs="+",default=['CalibNet','RGGNet','LCCNet','LCCNet (mr5)','LCCRAFT','CalibDepth',
        'RLCalib (IL)','RLCalib (IL+RL)','RLCalib (IL) (res)','RLCalib (IL+RL) (res)','RLCalib (IL) (G)','RLCalib (IL+RL) (G)','RLCalib (IL+RL) (s15)'])
