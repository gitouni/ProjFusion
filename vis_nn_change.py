...
if __name__ == "__main__":
    ...
    viz_nn_changes(u_gt, v_gt, mismatch_gt, image_np, res_dir / "nn_change_gt.{fmt}".format(fmt=args.fmt))
    ...
    print(f"GT Condition - (Wide View) - NN Mismatch Ratio: {ratio_m:.2f}%")
    viz_nn_changes(u_m, v_m, mismatch_m, image_np, res_dir / "nn_change_gt_expand.{fmt}".format(fmt=args.fmt), margin_ratio=margin_ratio)
    # ==========================================
    ...
    viz_nn_changes(u_noise, v_noise, mismatch_noise, image_np, res_dir / "nn_change_perturbed.{fmt}".format(fmt=args.fmt))
    ...
    viz_nn_changes(u_m, v_m, mismatch_m, image_np, res_dir / "nn_change_perturbed_expand.{fmt}".format(fmt=args.fmt), margin_ratio=margin_ratio)
